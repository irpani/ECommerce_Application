...
public class ElementUtil {
	...
	public WebElement getElement(By locator) {
		...
		// Now we want to Control highlight from config.property file so what we have to
		// do now is
		// How will u do this ,I have to read prop.getproperty("highlight") in my Driver
		// factory
